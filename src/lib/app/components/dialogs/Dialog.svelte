...
{#if shown}
	...
	>
		<div
			...
			class="flex w-5/6 flex-col items-center justify-center border-x border-y-3 border-x-white/10 border-y-blue-400 bg-blue-900/20 px-4 py-2 backdrop-blur-xl md:min-w-[650px] lg:w-1/2"
		>
